...
function desHabilitarMetodos(){
	document.getElementById("botonNDT").style.display = "none";
	document.getElementById("botonVida").style.display = "none";
	document.getElementById("botonFactor").style.display = "none";
}
function habilitarMetodos(){
	document.getElementById("botonNDT").style.display = "inline";
	document.getElementById("botonVida").style.display = "inline";
	document.getElementById("botonFactor").style.display = "inline";
}
...
function D0Corregido(){
	...
	document.getElementById("recibeformulad0Corr1").innerHTML= "d0 corregido = "+D0Corregido+" plg";
}
...
function EpMr() {
	...
	for (i = 0; i < 100; i += 0.01) {
		...
		if (0 <= EpMr && EpMr <= 0.001) {
			total=i;
			document.getElementById("recibeD0").innerHTML = document.getElementById('totalD0Cor').value+" = (1.5*"+p+"*"+a+"*(1/("+mr+"*((1+(("+D+"/"+a+")*(Ep/Mr)^1/3)^2)^1/2)) + ( 1.5*"+p+"*"+a+"*((1-(1/((1+("+D+"/"+a+")^2)^1/2)))/(Ep/Mr*"+mr+")) ) ) - "+cor+")";
			document.getElementById("recibeEpMr").innerHTML = "Ep/Mr= "+total.toFixed(6);

		}
	}
	document.getElementById("totalEpMr").value = total.toFixed(6);
	//REPORTE DESCRIP
	document.getElementById("recibedescriEpMr1").innerHTML = "Obteniendo por ambos métodos un valor Ep/Mr de "+total.toFixed(6);
...
function CalculoSN() {
	...
	for (i = 1; i < 10; i += 0.0001) {
		...
		if (0 <= sn && sn <=0.0001) {
			total = i;
			document.getElementById("recibeW18").innerHTML =w18+" = (("+zr+" * "+so+") + (9.36 * Log10(SN + 1)) - (0.2) + (((Log10(("+psi+") / (4.2 - 1.5)))) / (0.4 + (1094 / ((SN + 1)^ 5.19)))) + (2.32 * Log10("+mre+"))) - 8.07 - (Log10("+w18+"))";
			document.getElementById("recibeSN").innerHTML = "SN = "+total.toFixed(6);
			document.getElementById("recibeW181").innerHTML =w18+" = (("+zr+" * "+so+") + (9.36 * Log10(SN + 1)) - (0.2) + (((Log10(("+psi+") / (4.2 - 1.5)))) / (0.4 + (1094 / ((SN + 1)^ 5.19)))) + (2.32 * Log10("+mre+"))) - 8.07 - (Log10("+w18+"))";
			document.getElementById("recibeSN1").innerHTML = "SN = "+total.toFixed(6);
			document.getElementById("recibeW182").innerHTML =w18+" = (("+zr+" * "+so+") + (9.36 * Log10(SN + 1)) - (0.2) + (((Log10(("+psi+") / (4.2 - 1.5)))) / (0.4 + (1094 / ((SN + 1)^ 5.19)))) + (2.32 * Log10("+mre+"))) - 8.07 - (Log10("+w18+"))";
			document.getElementById("recibeSN2").innerHTML = "SN = "+total.toFixed(6);
			
		}
	}
	document.getElementById("totalSN").value=total.toFixed(6);
	document.getElementById('recibeDescrSnFut').innerHTML = 'Así, mediante la siguiente ecuación se puede obtener matemáticamente el SN futuro y mediante la forma gráfica tal como se muestra en la Figura 3, cuyo valor es '+total.toFixed(6);
...
function EsalsRemanente(a) {
	...
	document.getElementById("recibeW15").innerHTML = "Nro ESAL´S 1.5= (10^(("+zr+" * "+so+") + (9.36 * Log10("+sn+" + 1)) - (0.2) + (((Log10(("+psi+")  / (4.2 - 1.5)))) / (0.4 + (1094 / (("+sn+" + 1)^ 5.19)))) + (2.32 * Log10("+a+")) - 8.07)";
...
function DeflexionesDistancias(){
	...
	function BulboTension(){
		...
		if (dis1>tot1) {
			document.getElementById('moduloResRetro').value = totalmodulo1;
			...
			document.getElementById('recibeformulaTotvalidarT').innerHTML = "ae = "+validarTension1+" plg";
			...
			document.getElementById('recibedefdistrabajada').innerHTML = "De tal forma, que se trabajó con la deflexión y distancia 1 ";



		}if (dis2>tot2) {
			document.getElementById('moduloResRetro').value = totalmodulo2;
			...
			document.getElementById('recibeformulaTotvalidarT').innerHTML = "ae = "+validarTension2+" plg";
			...
			document.getElementById('recibedefdistrabajada').innerHTML = "De tal forma, que se trabajó con la deflexión y distancia 2";




		}if (dis3>tot3) {
			document.getElementById('moduloResRetro').value = totalmodulo3;
			...
			document.getElementById('recibeformulaTotvalidarT').innerHTML = "ae = "+validarTension3+" plg";
			...
			document.getElementById('recibedefdistrabajada').innerHTML = "De tal forma, que se trabajó con la deflexión y distancia 3";
	...
	function SnefNDT(){
		...
		document.getElementById('recibedescrsnefNDT1').innerHTML ="Para ello es necesario ingresar en el eje “x” el valor total del espesor del pavimento y cortar con la línea acorde al valor Ep calculado anteriormente, así el resultado del SNef es "+ total1.toFixed(3); 
		document.getElementById('recibedescrsnefNDT2').innerHTML ="Una vez obtenido el valor de SNef para el método, el SN futuro y habiendo definido el coeficiente estructural de la nueva carpeta con un valor de a = "+ document.getElementById('coefEstrucCarpAsNDT').value+"se calcula el espesor de sobrecarpeta mediante la siguiente ecuación:"; 
	}
...
function Sn0VidaRemanente(){
	...
	//IMPRIMIR
		...
		if (cmbselecSub ==''&&coefMejora1=='') {
			//Vida REma
			document.getElementById("recibeSnefVida").innerHTML = "SNef = ("+total+"*"+coef+")+("+EspBase+"*"+coefbas+"*"+coefDrena+")";
			document.getElementById("recibeTotalSnefVida").innerHTML = "SNef = "+Resultotal.toFixed(3);
		}else if (cmbselecSub!=''&&coefMejora1=='') {
			//VIDA REMA
			document.getElementById("recibeSnefVida").innerHTML = "SNef = ("+total+"*"+coef+")+("+EspBase+"*"+coefbas+"*"+coefDrena+")+("+subbase+"*"+coefsub1+"*"+coefDrena2+")";
			document.getElementById("recibeTotalSnefVida").innerHTML = "SNef = "+Resultotal.toFixed(3);

		}else if (cmbselecSub!=''&&coefMejora1!='') {
			//VIDA REMA
			document.getElementById("recibeSnefVida").innerHTML = "SNef = ("+total+"*"+coef+")+("+EspBase+"*"+coefbas+"*"+coefDrena+")+("+subbase+"*"+coefsub1+"*"+coefDrena2+")+("+EspeMateria+"*"+coefMejora1+"*"+coefDrena3+")";
			document.getElementById("recibeTotalSnefVida").innerHTML = "SNef = "+Resultotal.toFixed(3);
		}else if (cmbselecSub==''&&coefMejora1!='') {
			//VIDA REMA
			document.getElementById("recibeSnefVida").innerHTML = "SNef = ("+total+"*"+coef+")+("+EspBase+"*"+coefbas+"*"+coefDrena+")+("+EspeMateria+"*"+coefMejora1+"*"+coefDrena3+")";
			document.getElementById("recibeTotalSnefVida").innerHTML = "SNef = "+Resultotal.toFixed(3);
		}
...
function SnefVidaRemanente(){
	...
	//REPORTE
	document.getElementById("recibeDescriSnefVida").innerHTML = "Una vez obtenido el valor de SN0 y el CF para el método, realizamos el producto de los dos parámetros, obteniendo un SNef = "+total.toFixed(3);
...
function EspesorSobreCNDT(){
	...
	document.getElementById("recibeTotalDNDT").innerHTML = "D = "+total.toFixed(3)+" plg";
}
function EspesorSobreCFactor(){
	...
	document.getElementById("recibeTotalDFactor").innerHTML = "D = "+total.toFixed(3)+" plg";
}
function EspesorSobreCVida(){
	...
	document.getElementById("recibeTotalDVida").innerHTML = "D = "+total.toFixed(3)+" plg";
...
function comprobarMetodosActPro(){
	...
	if (ndt!=""&&factor!=""&&vida!="") {
		document.getElementById("btnProce").style.display = "inline";
		document.getElementById("imp2").style.display = "inline";
	}else{
...
function Procedimiento(){
	...
	document.getElementById("imp1").style.marginRight="32px";
...
function printDiv(){
	  ...
	  document.getElementById("recibeTotalEsp").innerHTML = "Espesor del pavimento: "+document.getElementById("espesorTotalPav").value+" plg";
	  ...
	  document.getElementById("recibeDesvEstan").innerHTML = "Desviación estándar (S0): "+document.getElementById("desviEst").value;
	  document.getElementById("recibeDesvEstanVida3").innerHTML = "Desviación estándar (S0): "+document.getElementById("desviEst").value;
	  document.getElementById("recibeEsalsF").innerHTML = "Nro. ESAL´s final: "+document.getElementById("nroFinal").value+" vehículos";
	  document.getElementById("recibetemp").innerHTML = "Temperatura (T): "+document.getElementById("temperatura").value+" °F";
	  document.getElementById("recibecarga").innerHTML = "Carga (P): "+document.getElementById("carga").value+" lbs";
	  document.getElementById("recibeplatcar").innerHTML = "Radio del plato de carga (a): "+document.getElementById("radioPlato").value+" plg";
	  document.getElementById("recibeDefcentro").innerHTML = "Deflexión al centro de la carga: "+document.getElementById("defleCentroCarga").value+" plg";
	  	...
	  	document.getElementById("recibeDCorre").innerHTML = "d0 Corregido: "+document.getElementById("totalD0Cor").value+" plg";
	  	document.getElementById("recibeTotalEp").innerHTML = "Ep/Mr: "+document.getElementById("totalEpMr").value+" plg";
	  ...
	  document.getElementById("recibedescnesal").innerHTML = "Siguiente a ello calculamos el porcentaje de vida remanente del pavimento cuyo valor es "+document.getElementById("RL").value+" con la siguiente fórmula:";
	  	...
	  	+ document.getElementById('espesorCarpAs').value + " plg; tal como se indica a continuación:";

	  //PARA EL CALCULO SN FUTURO
	  document.getElementById("recibeEsalsF1").innerHTML = "Nro. ESAL´s final: "+document.getElementById("nroFinal").value+" vehículos";
	  ...
	  document.getElementById("recibeDesvEstan1").innerHTML = "Desviación estándar (S0): "+document.getElementById("desviEst").value;
	  ...
	  document.getElementById("recibeGraficaCF").src = dataURL6;
	  	...
	  	//METODO FACTOR CONDICION
	  	document.getElementById("recibeconcreFact").innerHTML = "Espesor de carpeta asfáltica (e1): "+document.getElementById("espesorCarpAs").value+" plg";
	  	document.getElementById("recibebaseFact").innerHTML = "Espesor de base (e2): "+document.getElementById("espesorBase").value+" plg";
	  	//METODO VIDA REMANENTE
	  	document.getElementById("recibeconcreVida").innerHTML = "Espesor de carpeta asfáltica (e1): "+document.getElementById("espesorCarpAs").value+" plg";
	  	document.getElementById("recibebaseVida").innerHTML = "Espesor de base (e2): "+document.getElementById("espesorBase").value+" plg";
		...
		if (espeSubbaseFact == "") {
			...
			document.getElementById("recibesubbaseFact").innerHTML = "Espesor de subbase (e3):  "+document.getElementById("espesorSubBase").value+ " plg";

			document.getElementById('tablaSubbaseVida').style.display = 'table-row';
			document.getElementById("recibesubbaseVida").innerHTML = "Espesor de subbase (e3):  "+document.getElementById("espesorSubBase").value+ " plg";
		}
		...
		if (espeMaterialFact == "") {
			...
			document.getElementById("recibematerialFact").innerHTML = "Espesor de material de mejoramiento(e4):  "+document.getElementById("espesorMaterial").value+ " plg";

			document.getElementById('tablaMaterVida').style.display = 'table-row';
			document.getElementById("recibematerialVida").innerHTML = "Espesor de material de mejoramiento(e4):  "+document.getElementById("espesorMaterial").value+ " plg";
		...
		document.getElementById("recibeDesvEstanFact").innerHTML = "Desviación estándar (S0): "+document.getElementById("desviEst").value;
		document.getElementById("recibeEsalsFFact").innerHTML = "Nro. ESAL´s final: "+document.getElementById("nroFinal").value+" vehículos";
		...
		document.getElementById("recibeDesvEstanVida").innerHTML = "Desviación estándar (S0): "+document.getElementById("desviEst").value;
		document.getElementById("recibeEsalsFVida").innerHTML = "Nro. ESAL´s final: "+document.getElementById("nroFinal").value+" vehículos";
		document.getElementById("recibeEsalsIVida").innerHTML = "Nro. ESAL´s inicial: "+document.getElementById("nroInicial").value+" vehículos";
		...
		if (espesorSubBase==""&&coefDrenaSubBase=="") {
			...
			document.getElementById('tablaSubaseMetFac').style.display = 'table-row';
			document.getElementById("recibecoefSubbaseFact").innerHTML = 'SubBase: m2= '+coefDrenaSubBase+" ; a2= "+coefSubBase;

			document.getElementById('tablaSubaseMetVida').style.display = 'table-row';
		...
		document.getElementById("recibeEsalsFFact2").innerHTML = "Nro. ESAL´s final: "+document.getElementById("nroFinal").value+" vehículos";
		document.getElementById("recibezrFact2").innerHTML = "Desviación normal (Zr): "+document.getElementById("zr").value;
		document.getElementById("recibeDesvEstanFact2").innerHTML = "Desviación estándar (S0): "+document.getElementById("desviEst").value;
		...
		document.getElementById("recibeEsalsFVida2").innerHTML = "Nro. ESAL´s final: "+document.getElementById("nroFinal").value+" vehículos";
		document.getElementById("recibeDesvEstanVida2").innerHTML = "Desviación estándar (S0): "+document.getElementById("desviEst").value;
		...
		document.getElementById("recibemodresefecVida2").innerHTML = "Módulo resiliente efectivo (Mre): "+document.getElementById("totalModResEfectivo").value+" PSI";
	  	...
	  	document.getElementById('recibeDescripMet').innerHTML="Una vez obtenido el valor de SNef para el método, el SN futuro y habiendo definido el coeficiente estructural de la nueva carpeta con un valor de a = "+document.getElementById('coefEstrucCarpAsFactor').value+", se calcula el espesor de sobrecarpeta mediante la siguiente ecuación:";
	  	document.getElementById('recibeDescripCF').innerHTML="Finalmente en la Figura 7 encontramos el valor “CF”, siendo en el eje “x” con el %RL (porcentaje de vida remanente) y levantando una vertical cortando con la curva dada por la normativa, obteniendo un CF = "+document.getElementById('totalCF').value;
	  	document.getElementById('recibeDescriSnefVida1').innerHTML = "Una vez obtenido el valor de SNef para el método, el SN futuro y habiendo definido el coeficiente estructural de la nueva carpeta con un valor de a = "+document.getElementById('coefEstrucCarpAsVida').value+",se calcula el espesor de sobrecarpeta mediante la siguiente ecuación:"	
	 	...
	 	document.getElementById('descripTablaBase').style.fontSize = "24px";
	 	document.getElementById('descripTablaBase').removeAttribute("style");
	 	...
	 	document.getElementById('descripTablaSubBase').style.fontSize = "24px";
	 	document.getElementById('descripTablaSubBase').removeAttribute("style");
	 	...
	 	document.getElementById('descripTablaMaterial').style.fontSize = "24px";
	 	document.getElementById('descripTablaMaterial').removeAttribute("style");
	 	...
	 	document.getElementById('tabla5').setAttribute("style", "text-align: center;")
			...
			newWin.document.write('<html style="font-size: 24px"><head><style type="text/css"> @media print {@page {margin: 20mm 25mm 20mm 25mm;  }   } a:link {color:black; text-decoration: none} a:visited {color:black; text-decoration: none} a:active {color:black; text-decoration: none} a:hover {color:black; text-decoration: none}   </style> </head><body onload="window.print()" > '
				...
				+tablaDrenajeBase.innerHTML
				+tablametodoFact.innerHTML+recibeMetodoFactCondi1.innerHTML+'<p style = "page-break-after: always;"> &nbsp; </ p>'
				+inicioMetodoVida.innerHTML+recibeMetodoVidaRemante.innerHTML+recibeDesarroVida.innerHTML+recibeMetodoVidaRema.innerHTML+recibeMetodoVidaRema1.innerHTML+tablaDrenajeBase.innerHTML+tablaMetodoVida.innerHTML+recibecontVida.innerHTML+'</body></html>');
			...
			document.getElementById('descripTablaBase').style.fontSize = "12px";
			...
			document.getElementById('descripTablaSubBase').style.fontSize = "12px";
			...
			document.getElementById('descripTablaMaterial').style.fontSize = "12px";
